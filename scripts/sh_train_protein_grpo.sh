...
CHECKPOINT_RANK0_TIMEOUT_S=${CHECKPOINT_RANK0_TIMEOUT_S:-7200}
VALIDATION_RANK0_TIMEOUT_S=${VALIDATION_RANK0_TIMEOUT_S:-14400}
RANK0_SECTION_POLL_INTERVAL_S=${RANK0_SECTION_POLL_INTERVAL_S:-5}
...
TRAIN_ARGS+=(--resume_mode "$RESUME_MODE")
if [ -n "$SYNC_ROOT" ]; then
