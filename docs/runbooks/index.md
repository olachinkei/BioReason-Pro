...
- `coreweave-implementation.md`: CoreWeave SSH, Slurm, runtime paths, smoke tests, and cleanup boundaries.
- `coreweave-sunk-senpai.md`: Kubernetes Job launch on CoreWeave CKS with SUNK/Slurm scheduling.
