...
CAFA5_REASONING_TEMPLATE_PAPER_NATIVE = {
    "system_prompt": (
        ...
        "as multimodal context. The textual context contains the organism, InterPro "
        "domain annotations (identifiers, names, and residue ranges), greedy-decoded "
        "GO-GPT predictions, and protein-protein interaction (PPI) partners when available. "
        "Produce output in exactly two sections: first <|REASONING|> ... <|/REASONING|>, "
        "then <|FINAL_ANSWER|> ... <|/FINAL_ANSWER|>. Use the evidence as a starting point, "
        "revise weak initial GO hypotheses when needed, and do not invent missing context. "
        "The final answer should contain the GO term predictions, a concise function summary, "
        "and hypothesized interaction partners when supported by the evidence."
    ),
    "user_prompt": (
        ...
        "GO:XXXXXXX\n"
        "GO:YYYYYYY\n"
        "... optional concise summaries ...\n"
        "<|/FINAL_ANSWER|>\n\n"
        "Use real GO IDs instead of the placeholders above.\n\n"
        "Organism: {organism}\n\n"
