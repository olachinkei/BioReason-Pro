...
#SBATCH -o /mnt/home/%u/BioReason-Pro/runtime_logs/coreweave/eval_conservative_a2_%j.log
#
# Download conservative-a2-rmix artifact, copy go_embedding.pt, and run holdout eval
#
set -euo pipefail
...
ARTIFACT="wandb-healthcare/bioreason-pro/train-rl-conservative-a2-rmix-2node-2gen-step50-val40-best:v3"
LOCAL_DIR="/mnt/data/kkamata+cwb607/BioReason-Pro/data/artifacts/models/conservative_a2_rmix_step25/inference_export"
...
dl_dir = art.download(root='/mnt/data/kkamata+cwb607/BioReason-Pro/data/artifacts/models/conservative_a2_rmix_step25_raw')
...
python scripts/run_registered_eval.py \
  --target conservative-a2-rmix-step25 \
  --split test \
