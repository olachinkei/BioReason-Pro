...
#SBATCH -o /mnt/home/%u/BioReason-Pro/runtime_logs/coreweave/eval_nftu3zl2_rerun_%j.log
#
# Download rerun-nftu3zl2 artifact, copy go_embedding.pt, and run holdout eval
#
set -euo pipefail
...
ARTIFACT="wandb-healthcare/bioreason-pro/train-rl-rerun-nftu3zl2-a3-rmix-selective-portfix-best:v0"
LOCAL_DIR="/mnt/data/kkamata+cwb607/BioReason-Pro/data/artifacts/models/rerun_nftu3zl2_a3_rmix_selective/inference_export"
...
dl_dir = art.download(root='/mnt/data/kkamata+cwb607/BioReason-Pro/data/artifacts/models/rerun_nftu3zl2_a3_rmix_selective_raw')
...
if os.path.isdir(src):
    ...
    print('No inference_export subdir')
    os.makedirs(dst, exist_ok=True)
...
python scripts/run_registered_eval.py \
  --target rerun-nftu3zl2-a3-rmix-selective \
  --split test \
